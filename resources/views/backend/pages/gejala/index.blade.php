            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <nav class="nav">
                              <a class="nav-link active" href="{{route('gejala.create')}}">Tambah Data</a>
                            </nav>
                            <div class="card">
                              <div class="card-body">
                                <table class="table table-bordered table-sm">
                                  ...
                                  <tbody>
                                    @forelse($gejalas as $key => $v)
                                    <tr>
                                      <th scope="row">{{$key+1}}</th>
                                      <td class="text-center"><kbd>{{$v->kode_gejala}}</kbd></td>
                                      ...
                                      <td class="text-right">
                                        <div class="btn-group">
                                          ...
                                          <div class="dropdown-menu">
                                            <a class="dropdown-item" href="{{ route('gejala.show', $v->id) }}">Lihat</a>
                                            <a class="dropdown-item" href="{{ route('gejala.edit', $v->id) }}">Ubah</a>
                                            <a class="dropdown-item" href="{{ route('gejala.destroy', $v->id) }}"
                                           onclick="event.preventDefault();
                                                         document.getElementById('delete-form').submit();">
                                              Hapus
                                            </a>
                                            <form id="delete-form" action="{{ route('gejala.destroy', $v->id) }}" method="POST" onsubmit="return confirm('Yakin, mau dihapus ?');" 
